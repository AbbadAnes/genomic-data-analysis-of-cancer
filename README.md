...
we see that "ENS00000105605" gene that has obtained the highest score and therefore (the smallest P-value) is not used to predict the different types of cancer, but rather it's the preaching predictor of "LGG" cancer ( low grade giloma)
